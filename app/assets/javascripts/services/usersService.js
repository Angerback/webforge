...
angular.module('webforge')
    .factory('usersService', function($http){
        ...
        s.editUser = function(nameUserEdit,emailUserEdit,rutUserEdit,user_typeUserEdit, suspendedUserEdit, notifyUserEdit,selectedUserId){
            var obj = {"user":{"name":nameUserEdit,"email":emailUserEdit,"rut":rutUserEdit, "user_type":user_typeUserEdit, "suspended":suspendedUserEdit, "notificaciones":notifyUserEdit}};
            console.log(obj);
